    ...
    <div className="space-y-6 max-w-5xl">
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        <div className="bg-warm-white-pure p-6 rounded-2xl border border-sage-light shadow-sm">
           ...
           <p className="text-3xl font-serif text-text-primary mb-2">$42,500.00</p>
        ...
        <div className="bg-warm-white-pure p-6 rounded-2xl border border-sage-light shadow-sm">
           ...
           <p className="text-3xl font-serif text-text-primary mb-2">$18,240.50</p>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-sage-light text-sm">
               {[
                 { pro: 'Dr. Sarah Jenkins', amt: '$1,200.00', method: 'Stripe Connect', status: 'Ready' },
                 { pro: 'Michael Chen, MD', amt: '$840.50', method: 'Bank Transfer', status: 'Processing' },
                 { pro: 'Elena Rodriguez, LCSW', amt: '$450.00', method: 'Stripe Connect', status: 'Ready' },
               ].map((item, idx) => (
